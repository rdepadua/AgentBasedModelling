...
class Agent:
        ...
        def __init__(self, ia, environment, agents, y=None, x=None):
            self.id = ia
        ...
        def eat(self):
            ...
            if self.environment[self.y][self.x] > 10:
               ...
               self.store += 10
            # else:
        """ Check to see if function is working and and if there is no more grass to eat it will
            print this string statement " No more grass to eat" """ 
